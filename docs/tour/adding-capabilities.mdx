...
* **Identifying the [capabilities](/docs/concepts/capabilities.mdx)** your application needs. (Think common requirements like serving HTTP, storing key-value pairs, or logging.)
* **Adding interfaces** for those capabilities. 
...
In the next lesson, we'll look under the hood and learn exactly how interfaces work, along with how to deploy applications manually.
